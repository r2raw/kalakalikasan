...
class StoreRegistration extends ConsumerStatefulWidget {
  const StoreRegistration({super.key, required this.onRefresh});
  final VoidCallback onRefresh;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() {
    // TODO: implement createState
    return _StoreRegistration();
  }
}

class _StoreRegistration extends ConsumerState<StoreRegistration> {
  ...
  void _submitRegistration() async {
    try {
      if (_formKey.currentState!.validate()) {
        ...
        final checkStoreUrl =
            Uri.https('kalakalikasan-server.onrender.com', 'verify-store');
        ...
        final url =
            Uri.https('kalakalikasan-server.onrender.com', 'register-store');
