...
class OfficerReceiptResultScreen extends ConsumerStatefulWidget {
  const OfficerReceiptResultScreen({super.key});

  @override
  ConsumerState<OfficerReceiptResultScreen> createState() {
    return _OfficerReceiptResultScreen();
  }
}

class _OfficerReceiptResultScreen extends ConsumerState<OfficerReceiptResultScreen> {
  List materials = [];
  @override
  void initState() {
    super.initState();
