...
class DirectCashScreen extends ConsumerStatefulWidget {
  const DirectCashScreen({super.key});
  @override
  ConsumerState<DirectCashScreen> createState() {
    return _DirectCashScreen();
  }
}

class _DirectCashScreen extends ConsumerState<DirectCashScreen> {
  ...
  void _onSubmit() async {
    try {
      ...
      final url = Uri.https('kalakalikasan-server.onrender.com', 'direct-cash');
